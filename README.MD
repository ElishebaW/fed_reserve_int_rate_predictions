...
3. Fix the release gate script to work with the current environment. Undeploy should work with the current environment. Deploy should work with the current environment. Run like this 
